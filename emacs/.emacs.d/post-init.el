...
(use-package doom-modeline
  ...
  (doom-modeline-def-modeline 'main
    ...
    '(selection-info buffer-position word-count objed-state persp-name battery grip irc mu4e gnus github debug lsp minor-modes input-method indent-info buffer-encoding major-mode process vcs)))

;; Temp fix for 
;; Error in post-command-hook (evil-normal-post-command): 
;; (void-variable evil-mode-buffers)
;; from https://github.com/emacs-evil/evil/issues/1983 
...
(use-package general
  ...
  (leader-keys
    ...
    "fb" '(consult-line :which-key "search in buffer")
    "fp" '(consult-ripgrep :which-key "search in project")
    ...
    "og" '(consult-outline :which-key "goto")
    "oG" '(consult-imenu-multi :which-key "goto all")
    ...
    ;; Clipboard history
    "k" '(consult-yank-pop :which-key "kill ring")
